...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-bg relative overflow-hidden">
      ...
      <div className="absolute top-20 left-20 w-72 h-72 bg-banana/20 rounded-full blur-[100px] animate-pulse" />
      <div className="absolute bottom-20 right-20 w-96 h-96 bg-orange-500/10 rounded-full blur-[120px] animate-pulse delay-700" />
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <Card className="bg-dark-card/80 backdrop-blur-xl border-dark-border shadow-2xl">
          <CardHeader className="text-center space-y-4">
            ...
            <div>
              ...
              <CardDescription className="text-gray-400 mt-2">登录您的账户继续创作</CardDescription>
            </div>
          </CardHeader>
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-xs text-banana hover:text-banana-light">
                    忘记密码？
                  </Link>
                </div>
                <Input
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <p className="text-sm text-gray-500 text-center">
                还没有账户？{' '}
                <Link to="/register" className="text-banana hover:text-banana-light font-medium transition-colors">
                  立即注册
                </Link>
              </p>
            </CardFooter>
        ...
        <p className="text-center text-xs text-gray-600 mt-8">
          © 2024 香蕉 AI. All rights reserved.
        </p>
      </div>
    </div>
  );
